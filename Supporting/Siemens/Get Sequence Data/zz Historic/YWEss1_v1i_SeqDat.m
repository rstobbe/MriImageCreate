...
function [ExpPars,PanelOutput,err] = YWEss1_v1i_SeqDat(MrProt,DataInfo)
...
Panel(11,:) = {'wedelay (us)',ExpPars.Sequence.wedelay,'Output'};
Panel(12,:) = {'greftwk',ExpPars.Sequence.greftwk,'Output'};
