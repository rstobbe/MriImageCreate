...
function [ExpPars,PanelOutput,err] = YMTEsa1_v1i_SeqDat(MrProt,DataInfo)

err.flag = 0;
err.msg = '';

Status2('busy','Load ''YMTEsa1'' Sequence Info',2);
...
Panel(14,:) = {'asymmref)',ExpPars.Sequence.asymmref,'Output'};
