...
function [ExpPars,PanelOutput,err] = YMTEwe1_v1i_SeqDat(MrProt,DataInfo)
...
Panel(11,:) = {'tbw',ExpPars.Sequence.tbw,'Output'};
Panel(12,:) = {'wedelay (us)',ExpPars.Sequence.wedelay,'Output'};
Panel(13,:) = {'greftwk',ExpPars.Sequence.greftwk,'Output'};
Panel(14,:) = {'rdwn (us)',ExpPars.Sequence.rdwn,'Output'};
