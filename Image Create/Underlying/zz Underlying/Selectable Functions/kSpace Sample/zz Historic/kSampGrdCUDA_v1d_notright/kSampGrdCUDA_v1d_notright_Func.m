...
function [KSMP,err] = kSampGrdCUDA_v1d_Func(KSMP,INPUT)
...
StatLev = 3;
[Dat,err] = mG2SCUDADoubleC_v4g(ZF,Kx,Ky,Kz,KERN,ftOb,CONV,StatLev,[]);
if err.flag
    return
end
...
% Scale
%---------------------------------------------
Dat = Dat/(KRNprms.convscaleval*KRNprms.DesforSS^3);
