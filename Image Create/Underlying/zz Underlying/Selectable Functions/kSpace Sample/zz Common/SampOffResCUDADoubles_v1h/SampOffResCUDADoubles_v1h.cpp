...
#include "CUDA_FFTDoubles_v1b.h"
#include "CUDA_FFTShiftD_v1d.h"
#include "CUDA_PhaseAddOffResD_v2c.h"
#include "CUDA_ConvGrid2SampSplitCD_v1d.h"
...
// Input                        
//-------------------------------------
double *ImR,*ImI,*OffRes,*T,*Kx,*Ky,*Kz,*Kern;
int *tempipt;
int iKern,chW;
...
mwSize *HImC0, *HImC1, *HOffC, *HkDatC, *HkDatCshft, *HKx, *HKy, *HKz, *HKern, *HSampDatR, *HSampDatI;
mwSize addreslen = 1;
