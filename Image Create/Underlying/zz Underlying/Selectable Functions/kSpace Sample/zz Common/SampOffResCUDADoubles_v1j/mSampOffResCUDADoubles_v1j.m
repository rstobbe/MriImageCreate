...
function [Dat,err] =  mSampOffResCUDADoubles_v1j(Im,Off,T,Kx,Ky,Kz,KERN,CONV,StatLev)
...
% Sample
%------------------------------------
[Dat,Test,Error] = SampOffResCUDADoubles_v1j(Im,Off,T,Kx,Ky,Kz,Kern,iKern,chW,Stathands);
