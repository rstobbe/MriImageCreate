...
function [RFOV,err] = ReturnFov_All_v1a_Func(RFOV,INPUT)
...
% Head FoV
%---------------------------------------------
if not(isfield(ReconPars0,'ImfovTB'))
    ImfovTB = ReconPars0.Imfovx;
    ImfovLR = ReconPars0.Imfovy;
    ImfovIO = ReconPars0.Imfovz;
else
    ImfovTB = ReconPars0.ImfovTB;
    ImfovLR = ReconPars0.ImfovLR;
    ImfovIO = ReconPars0.ImfovIO;
end
