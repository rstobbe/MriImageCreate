...
function [default] = kShiftCorOnlyMSYB_v1a_Default2(SCRPTPATHS)
...
if strcmp(filesep,'\')
    ...
    kshftcorpath = [SCRPTPATHS.Vrootloc,'Image Creation\Underlying\zz Underlying\Selectable Functions\Motion Correction\Motion Correction Regression\'];   
