...
function [default] = TransCorOnlyMSYB_v1a_Default2(SCRPTPATHS)
...
if strcmp(filesep,'\')
    ...
    transcorpath = [SCRPTPATHS.Vrootloc,'Image Creation\Underlying\zz Underlying\Selectable Functions\Motion Correction\Motion Correction Regression\'];   
