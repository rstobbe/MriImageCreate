...
function [MOTCOR,err] = RotTransCorOnlyMSYB_v1a_Func(MOTCOR,INPUT)

Status2('busy','Correct for Rotation and Translation (MSYB)',2);
Status2('done','',3);
...
arrDAT = KSMP.SampDat;
IMG = MOTCOR.IMG;
ROTTRANSCOR = MOTCOR.ROTTRANSCOR;
Kmat = IMP.Kmat;
clear INPUT;
...
[ROTTRANSCOR,err] = func(ROTTRANSCOR,INPUT);
if err.flag
    return
end
Kmat = ROTTRANSCOR.Kmat;
ROTTRANSCOR = rmfield(ROTTRANSCOR,'Kmat');
