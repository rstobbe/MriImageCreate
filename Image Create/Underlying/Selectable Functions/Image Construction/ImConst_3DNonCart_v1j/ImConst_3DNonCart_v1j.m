%=========================================================
% (v1j) 
%   - Update to gridding for Knitter
%=========================================================

function [SCRPTipt,SCRPTGBL,IC,ReturnData,err] = ImConst_3DNonCart_v1j(SCRPTipt,SCRPTGBL,ICipt,FID)
...
% Gridding
%---------------------------------------------
GRD.method = 'GridkSpace_LclKern_v1l';
